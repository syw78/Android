...
public class dongmid888 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dongmid888);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(),dongmid88.class);
    ...
    public void onClick(View view){
        ...
        task.execute("https://www.kma.go.kr/wid/queryDFSRSS.jsp?zone=2871025000");
