...
public class dongmid999 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dongmid999);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(),dongmid99.class);
    ...
    public void onClick(View view){
        ...
        task.execute("https://www.kma.go.kr/wid/queryDFSRSS.jsp?zone=5013025300");
