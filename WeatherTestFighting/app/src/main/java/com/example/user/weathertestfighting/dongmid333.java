...
public class dongmid333 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dongmid333);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(),dongmid33.class);
    ...
    public void onClick(View view){
        ...
        task.execute("https://www.kma.go.kr/wid/queryDFSRSS.jsp?zone=2920054000");
