...
public class gangneung2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gangneung2);
    ...
    public void onClick(View view){
        ...
        task.execute("https://www.kma.go.kr/wid/queryDFSRSS.jsp?zone=4215066500");
