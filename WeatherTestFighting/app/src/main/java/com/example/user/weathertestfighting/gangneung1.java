...
public class gangneung1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gangneung1);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(),dongmid11.class);
    ...
    public void onClick(View view){
        ...
        task.execute("https://www.kma.go.kr/wid/queryDFSRSS.jsp?zone=4215034000");
