...
public class GVAdapter extends BaseAdapter {
    ...
    public GVAdapter(Context context, int layout ,ArrayList<SubData> array) {
        this.context = context;
        this.layout = layout;
        this.array = array;
    ...
    private void resetDayNumbers() {
        ...
        for (int i = 0; i < 42; i++) {
            ...
            // array.add(subData);
            Log.i("resetDayNumbers","resetDayNumbers : "+dayNumber);
            Log.i("resetDayNumbers","resetDayNumbers : "+array.size());
            array.add(new SubData(dayNumber));
        }
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        final TextView tvTalk = view.findViewById(R.id.tvTalk);
        final ImageView ivImage = view.findViewById(R.id.ivImage);
        //LinearLayout linear = view.findViewById(R.id.linear);
        final SubData item = array.get(i);
...
//        });
        ...
        final SubData subData = array.get(i);
